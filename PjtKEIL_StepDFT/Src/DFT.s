...
DFT_ModuleAuCarre PROC
	...
	mov r2, #0 ;i
	mov r3, #0 ; partie reel
	mov r4 , #0 ; partie imaginaire
...
Bouclefor
	...
	ldrsh r7, [r0,r2, lsl#1] ;recuperer x(i)
	mul r8 , r2 , r1 ; r8=p=k*n 
	mov r11 , #63
	and r8,r11
	ldrsh r10, [r5,r8,lsl#1] ; recup cos(p)
	ldrsh r9, [r6,r8,lsl#1] ; recup sin(p) !!!prob ici
	...
	bne Bouclefor  ;!!!prob sortie de la boucle
